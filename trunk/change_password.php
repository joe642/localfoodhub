...
if(!empty($_POST['Change']))
{
	...
	$testpassword = mysql_query("SELECT member_password FROM member WHERE member_id = $_SESSION[member_id]");
	...
	else
	{
		...
		mysql_query("UPDATE member SET member_password = '$md5pass' WHERE member_id = $_SESSION[member_id]");
